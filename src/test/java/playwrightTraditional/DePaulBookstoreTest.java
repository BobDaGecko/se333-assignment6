...
public class DePaulBookstoreTest {
    ...
    /**
     * TestCase 2: Your Shopping Cart Page Verify cart contents, select pickup, verify pricing, test
     * promo code
     */
    @Test
    ...
    void testCase2_ShoppingCartPage() {
        ...
        // AssertThat sidebar subtotal (164.98), handling (3.00), taxes (value is "TBD"), and
    ...
    void testCase5_PickupInformation() {
        ...
        assertThat(page.locator("label")
                .filter(new Locator.FilterOptions().setHasText("I'll pick them up")).locator("span")
                .nth(1)).isVisible();

        // AssertThat Sidebar order subtotal (164.98), handling (3.00), taxes (value is "TBD"), and
        // estimated total (167.98)
        assertThat(page.getByLabel("main")).containsText("$164.98");
        assertThat(page.getByLabel("main")).containsText("$3.00");
        assertThat(page.getByLabel("main")).containsText("TBD");
    ...
    /**
     * TestCase 6: Payment Information Verify final pricing with calculated tax and return to cart
     */
    @Test
    ...
    void testCase6_PaymentInformation() {
        ...
        // AssertThat Sidebar order subtotal (164.98), handling (3.00), taxes (17.22), and total
        // (185.20)
        assertThat(page.getByLabel("main")).containsText("$164.98");
        assertThat(page.getByLabel("main")).containsText("$3.00");
